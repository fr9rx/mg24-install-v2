...
It automatically copies the necessary SDK folders (`CMSIS`, `emlib`, `Device`) into local hidden directories for use with [`mg24-hal`](https://github.com/fr9rx/mg24-hal):
